...
import ro.euvt.springtest.difexample.SingletonComponent;
import ro.euvt.springtest.difexample.TransientComponent;

@SpringBootApplication
public class MySpringApplication {
    public static void main(String[] args) {
//
// Run this main function and inspect the output console to lear
